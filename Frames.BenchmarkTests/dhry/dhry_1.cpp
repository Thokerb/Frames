...
#endif
extern "C" __declspec(dllexport) int dhrystoneRun(int parameterNofRuns)
{
    // You can either move the whole benchmark code here
    // OR create an instance of your class and delegate to it:

    DhryStone ds;
    return ds.dhrystoneRun(parameterNofRuns);  // you'd need to refactor the class to have run()
}
