...
public class SpeedControlTest : TestKit, IClassFixture<OpenTelemetryFixture>
{
    ...
    public async Task BaseSpeedControlTest()
    {
        ...
        // Assert
        var response = await ExpectMsgAsync<Simulation.IsCompleted>(TimeSpan.FromSeconds(15));
        watch.Stop();
